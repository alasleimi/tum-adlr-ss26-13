...
def test_pendulum_grid_cell_summary():
    rows = [
        {"theta": 0.0, "theta_dot": 0.0, "return": -10.0, "task_success": 1.0, "near_upright_fraction": 1.0, "not_near_upright_streak": 0.0},
        {"theta": 0.0, "theta_dot": 0.0, "return": -300.0, "task_success": 0.0, "near_upright_fraction": 0.1, "not_near_upright_streak": 100.0},
    ]

    summary = summarize_cells(rows, np.asarray([0.0]), np.asarray([0.0]))
    assert summary[0]["task_success_rate"] == 0.5
